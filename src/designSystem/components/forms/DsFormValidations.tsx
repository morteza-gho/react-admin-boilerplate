...
import DsFormInput from "./DsFormInput";
import DsButton from '../buttons/DsButton';
import { Form } from "antd";
import { ICustomError, IFieldData } from "./types";
import DsCheckboxRadio from "../checkboxRadios/DsCheckboxRadio";
import { IRadioItem } from "../checkboxRadios/type";
import DsFormSelect from './DsFormSelect';
        ...
        <div className="ds-section-vaients md:w-1/2">
          ...
          >
            ...
            <div className="flex gap-x-2">
              <DsButton type="outline-green" htmlType="submit" text="Submit Form" />
              <DsButton type="outline-blue" htmlType="button" text="Fill Form" onClick={fillForm} />
              <DsButton type="outline-black" htmlType="button" text="Reset" onClick={resetForm} />
            </div>
          </DsForm>
...
export default DsFormValidations;